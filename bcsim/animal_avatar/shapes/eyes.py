EYES = (
    ...
    lambda color:
    '<path fill="#15212a" d="M339.3 256.8c0 15.3-8 15.1-17.9 15.1-9.8 '
    '0-17.8.2-17.8-15 0-15.4 8-27.8 17.8-27.8 9.9 0 17.9 12.4 17.9 27.7z"/>'
    '<ellipse cx="329.2" cy="241.9" fill="#fff" rx="5.1" ry="7.5" transform="rotate(-22 329.2 242)"/>'
    '<path fill="#15212a" d="M196.5 256.8c0 15.3-8 15.1-18 '
    '15.1s-17.8.2-17.8-15c0-15.4 8-27.8 17.9-27.8s17.9 12.4 17.9 27.7z"/>'
